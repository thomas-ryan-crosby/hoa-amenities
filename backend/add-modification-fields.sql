...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
                   WHERE table_name = 'reservations' AND column_name = 'modificationStatus') THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE constraint_name = 'fk_modification_proposed_by' 
