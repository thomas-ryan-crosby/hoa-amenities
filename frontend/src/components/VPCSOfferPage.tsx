    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb' }}>
        ...
        <section style={{
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <ul style={{
              ...
              <li>Lead customer onboarding and implementation</li>
              <li>Manage customer accounts and relationships</li>
              <li>Drive customer retention and satisfaction</li>
              <li>Build and manage customer success team</li>
              <li>Develop customer success processes and best practices</li>
              <li>Monitor customer health and identify expansion opportunities</li>
              <li>Collaborate with sales and product teams on customer needs</li>
            </ul>
          </div>
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <ul style={{
              ...
              <li>8+ years of customer success or account management experience</li>
              <li>5+ years in leadership roles</li>
              <li>Experience in SaaS or technology companies</li>
              <li>Strong track record of customer retention and satisfaction</li>
              <li>Experience building and scaling customer success teams</li>
      ...
      <footer style={{
        ...
        <p style={{
          ...
          © 2024 Neighbri. All rights reserved. Confidential - For VP Customer Success Candidates Only.
        </p>
      </footer>
    </div>
  );
