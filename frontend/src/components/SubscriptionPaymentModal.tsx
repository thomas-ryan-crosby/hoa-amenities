      ...
      <div style={{
        ...
        <div style={{ marginBottom: '20px', padding: '12px', backgroundColor: '#f0f9ff', border: '1px solid #0ea5e9', borderRadius: '4px' }}>
          <p style={{ margin: 0, fontSize: '14px', color: '#0c4a6e' }}>
            {communityName && `Thank you for registering ${communityName}! `}
            To complete your community setup, please review and acknowledge the monthly subscription fee.
          </p>
        </div>
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: '13px', color: '#78350f' }}>
            Square payment integration will be available soon. For now, please acknowledge that you understand the monthly subscription fee.
          </p>
        </div>
        ...
        <div style={{ marginBottom: '20px' }}>
          <label style={{
            ...
            <span style={{
              ...
              I understand I will need to pay ${monthlyFee.toFixed(2)}/month for this community subscription. Square payment integration will be available in the future.
            </span>
          </label>
        </div>
