...
const VPMarketingOfferPage: React.FC = () => {
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb' }}>
        ...
        <section style={{
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <ul style={{
              ...
              <li><strong>Base Salary:</strong> $120,000 - $160,000 (commensurate with experience)</li>
              <li><strong>Equity:</strong> 1% - 1.5% (from employee option pool)</li>
          ...
          <div style={{
            ...
            <ul style={{
              ...
              <li><strong>Grant:</strong> 1-1.5% equity (from employee option pool)</li>
        ...
        <section style={{
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <ul style={{
              ...
              <li>Develop and execute marketing strategy and brand positioning</li>
              <li>Lead demand generation and lead generation programs</li>
              <li>Manage content marketing and communications</li>
              <li>Build and manage marketing team</li>
              <li>Establish marketing operations and analytics</li>
              <li>Support sales team with marketing materials and campaigns</li>
              <li>Drive brand awareness and market presence</li>
            </ul>
          </div>
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <ul style={{
              ...
              <li>8+ years of marketing experience</li>
              <li>5+ years in leadership roles</li>
              <li>Experience in SaaS or B2B technology companies</li>
              <li>Strong track record in demand generation and lead generation</li>
              <li>Experience with marketing automation and analytics</li>
      ...
      <footer style={{
        ...
        <p style={{
          ...
          © 2024 Neighbri. All rights reserved. Confidential - For VP Marketing Candidates Only.
        </p>
      </footer>
    </div>
  );
...
export default VPMarketingOfferPage;
